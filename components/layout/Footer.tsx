      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 pb-12 border-b border-maroon-800/80">
          ...
          <motion.div custom={0} variants={columnVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-10%' }} className="lg:col-span-1 space-y-4">
            <div className="flex items-center">
              <div className="bg-white p-3 rounded-2xl shadow-lg border border-white/20 inline-block">
                <img src="/ojas.png" alt="Ojas Logo" className="h-12 w-auto object-contain" />
              </div>
            </div>
          ...
          <motion.div custom={4} variants={columnVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-10%' }} className="flex flex-col">
            ...
            <div className="newsletter mt-2">
              <p className="text-cream/70 text-xs mb-3 font-medium">Get health tips & appointment reminders</p>
              <form onSubmit={handleSubscribe} className="relative border-b border-cream/30 focus-within:border-gold transition-colors pb-1">
                <input 
                  type="email" 
                  value={email}
                  ...
                  required 
                  className="w-full bg-transparent border-none outline-none text-cream text-sm placeholder:text-cream/40 px-1 pr-8"
                />
                <button type="submit" aria-label="Subscribe" className="absolute right-0 top-1/2 -translate-y-1/2 text-cream hover:text-gold transition-colors">
        ...
        <div className="pt-4 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-cream/40 font-medium">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-x-6 gap-y-2">
            ...
            <a href="#" className="hover:text-cream/80 transition-colors">Terms & Conditions</a>
          </div>
        </div>
      </div>
    </footer>
